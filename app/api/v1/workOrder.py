...
from app.schemas.work_order import WorkOrdersRead, NewWorkOrder, WorkOrderUpdate,WorkOrdersReadId
...
@router.get("/", response_model=List[WorkOrdersRead] | WorkOrdersReadId)
...
@router.post("/", response_model=WorkOrdersReadId)
